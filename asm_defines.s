...
.equ ITEM_VENUSAURITE_G, 119
.equ ITEM_CHARIZARDITE_G, 120
.equ ITEM_BUTTERFRITE, 121
.equ ITEM_MACHAMPITE, 122
.equ ITEM_GENGARITE_G, 123
.equ ITEM_KINGLERITE, 124
.equ ITEM_SNORLAXITE, 125
.equ ITEM_GARBODORITE, 126
.equ ITEM_DREDNAWITE, 127
.equ ITEM_APPLITE, 128
.equ ITEM_SANDACONDITE, 129
.equ ITEM_GRIMMSNARITE, 130
.equ ITEM_ALCREMITE, 131
.equ ITEM_URSHIFITE, 132
...
.equ ITEM_CENTISKORITE, 265
.equ ITEM_HATTERITE, 266
.equ ITEM_COPPERITE, 267
.equ ITEM_DURALUDITE, 268
.equ ITEM_INFINITE_REPEL, 269
.equ ITEM_SOOT_SACK, 270
.equ ITEM_MANSE_KEY, 271
...
.equ ITEM_BLASTOISINITE_G, 278
.equ ITEM_LAPRASITE, 279
.equ ITEM_MELMETALITE, 280
.equ ITEM_RILLABITE, 281
.equ ITEM_CINDERITE, 282
.equ ITEM_INTELLEITE, 283
.equ ITEM_CORVIKNITE, 284
.equ ITEM_STORAGE_KEY, 285
.equ ITEM_ORBEETLITE, 286
.equ ITEM_COALOSSITE, 287
.equ ITEM_TOXTRICITE, 288
.equ ITEM_TM01, 289
.equ ITEM_TM02, 290
.equ ITEM_TM03, 291
.equ ITEM_TM04, 292
...
@;FireRed/LeafGreen
.equ ITEM_POKE_CHIP, 349
.equ ITEM_POKE_CHIP_CHARM, 350
.equ ITEM_OWL_KEY, 351
.equ ITEM_CYPRESS_KEY, 352
.equ ITEM_GOLD_TEETH, 353
.equ ITEM_SERPENT_KEY, 354
.equ ITEM_CERBERUS_KEY, 355
.equ ITEM_FACTORY_KEY, 356
.equ ITEM_RUSTED_DATA, 357
.equ ITEM_DECODER, 358
...
.equ ITEM_ABILITY_PATCH, 366
.equ ITEM_VICTORY_FLAG, 367
.equ ITEM_ADM, 368
.equ ITEM_GALARICA_CUFF, 369
.equ ITEM_GALARICA_WREATH, 370
.equ ITEM_CATCHING_CHARM, 371
.equ ITEM_DEX_NAV, 372
.equ ITEM_PORTA_PC, 373
.equ ITEM_POKE_VIAL, 374
...
.equ ITEM_BLACK_AUGURITE, 0x293
.equ ITEM_PEAT_BLOCK, 0x294
.equ ITEM_HISUI_ROCK, 0x295
.equ ITEM_REINS_OF_UNITY, 0x296
...
.equ ITEM_RUSTED_SWORD, 0x2C6
.equ ITEM_RUSTED_SHIELD, 0x2C7

@;Sword & Shield Evolution Items
.equ ITEM_SWEET_APPLE, 0x2C8
.equ ITEM_TART_APPLE, 0x2C9
.equ ITEM_CRACKED_POT, 0x2CA
.equ ITEM_CHIPPED_POT, 0x2CB
.equ ITEM_STRAWBERRY_SWEET, 0x2CC
.equ ITEM_BERRY_SWEET, 0x2CD
.equ ITEM_LOVE_SWEET, 0x2CE
.equ ITEM_CLOVER_SWEET, 0x2CF
.equ ITEM_FLOWER_SWEET, 0x2D0
.equ ITEM_RIBBON_SWEET, 0x2D1
.equ ITEM_STAR_SWEET, 0x2D2
@ Room for 2 more without expanding item table
...
@ Map names
.equ MAPSEC_ANTHRA_TOWN, 0x58
.equ MAPSEC_OLENIC_TOWN, 0x59
.equ MAPSEC_RHODANZI_CITY, 0x5A
.equ MAPSEC_FERROX_VILLAGE, 0x5B
.equ MAPSEC_HELEO_CITY, 0x5C
.equ MAPSEC_DAIMYN_CITY, 0x5D
.equ MAPSEC_LAPLAZ_TOWN, 0x5E
.equ MAPSEC_BRUCCIE_VILLAGE, 0x5F
.equ MAPSEC_EMRALDIN_QUAY, 0x60
.equ MAPSEC_TSARVOSA_CITY, 0x61
.equ MAPSEC_UTEYA_VILLAGE, 0x62
.equ MAPSEC_ROUTE_11_NORTH, 0x63
.equ MAPSEC_ROUTE_12_WEST, 0x64
.equ MAPSEC_ROUTE_1, 0x65
.equ MAPSEC_ROUTE_2, 0x66
.equ MAPSEC_ROUTE_3, 0x67
.equ MAPSEC_ROUTE_4, 0x68
.equ MAPSEC_ROUTE_5, 0x69
.equ MAPSEC_ROUTE_6, 0x6A
.equ MAPSEC_ROUTE_7, 0x6B
.equ MAPSEC_ROUTE_8, 0x6C
.equ MAPSEC_ROUTE_9, 0x6D
.equ MAPSEC_ROUTE_10, 0x6E
.equ MAPSEC_ROUTE_11_SOUTH, 0x6F
.equ MAPSEC_ROUTE_12_REST_HOUSE, 0x70
.equ MAPSEC_ROUTE_13_REST_HOUSE, 0x71
.equ MAPSEC_ROUTE_14, 0x72
.equ MAPSEC_ROUTE_15, 0x73
.equ MAPSEC_ROUTE_16, 0x74
.equ MAPSEC_ROUTE_17, 0x75
.equ MAPSEC_ROUTE_18, 0x76
.equ MAPSEC_ROUTE_19, 0x77
.equ MAPSEC_ROUTE_20, 0x78
.equ MAPSEC_ROUTE_21, 0x79
.equ MAPSEC_ROUTE_22, 0x7A
.equ MAPSEC_ROUTE_23, 0x7B
.equ MAPSEC_ROUTE_24, 0x7C
.equ MAPSEC_ROUTE_13, 0x7D
.equ MAPSEC_VARISI_FOREST, 0x7E
.equ MAPSEC_RUBARR_DESERT, 0x7F
.equ MAPSEC_TORMA_CAVE, 0x80
.equ MAPSEC_HELEO_RANCH, 0x81
.equ MAPSEC_FORGOTTEN_MANSE, 0x82
.equ MAPSEC_LAKE_LAPLAZ, 0x83
.equ MAPSEC_PERADON_FOREST, 0x84
.equ MAPSEC_CARNELIDGE_VOLCANO, 0x85
.equ MAPSEC_SEPPIRE_COVE, 0x86
.equ MAPSEC_ORICHELLE_GARDEN, 0x87
.equ MAPSEC_MIMMETT_JUNGLE, 0x88
.equ MAPSEC_VICTORY_ROAD, 0x89
.equ MAPSEC_HESSON_PASS, 0x8A
.equ MAPSEC_UTEYAN_RUINS, 0x8B
.equ MAPSEC_ASCENSION_TOWER, 0x8C
.equ MAPSEC_ROUTE_12_EAST, 0x8D
.equ MAPSEC_DAIMYN_FACTORY, 0x8E

@Move Tutors
@NUM_MOVE_TUTORS must match src/config.h
.equ NUM_MOVE_TUTORS, 96

@Special Move Tutors - anchored at NUM_MOVE_TUTORS, same order as include/constants/tutors.h
.equ TUTOR_SPECIAL_DRACO_METEOR,    NUM_MOVE_TUTORS + 0
.equ TUTOR_SPECIAL_SECRET_SWORD,    NUM_MOVE_TUTORS + 1
.equ TUTOR_SPECIAL_RELIC_SONG,      NUM_MOVE_TUTORS + 2
.equ TUTOR_SPECIAL_VOLT_TACKLE,     NUM_MOVE_TUTORS + 3
.equ TUTOR_SPECIAL_DRAGON_ASCENT,   NUM_MOVE_TUTORS + 4
.equ TUTOR_SPECIAL_THOUSAND_ARROWS, NUM_MOVE_TUTORS + 5
.equ TUTOR_SPECIAL_THOUSAND_WAVES,  NUM_MOVE_TUTORS + 6
.equ TUTOR_SPECIAL_CORE_ENFORCER,   NUM_MOVE_TUTORS + 7
.equ TUTOR_SPECIAL_STEEL_BEAM,      NUM_MOVE_TUTORS + 8
.equ TUTOR_SPECIAL_ASSIST,          NUM_MOVE_TUTORS + 9
.equ TUTOR_SPECIAL_SECRETPOWER,     NUM_MOVE_TUTORS + 10
.equ TUTOR_SPECIAL_PAYDAY,          NUM_MOVE_TUTORS + 11
.equ TUTOR_SPECIAL_FLAMEBURST,      NUM_MOVE_TUTORS + 12
.equ TUTOR_SPECIAL_MYSTICALFIRE,    NUM_MOVE_TUTORS + 13
.equ TUTOR_SPECIAL_INCINERATE,      NUM_MOVE_TUTORS + 14
.equ TUTOR_SPECIAL_AQUARING,        NUM_MOVE_TUTORS + 15
.equ TUTOR_SPECIAL_BRINE,           NUM_MOVE_TUTORS + 16
.equ TUTOR_SPECIAL_RAZORSHELL,      NUM_MOVE_TUTORS + 17
.equ TUTOR_SPECIAL_SPARK,           NUM_MOVE_TUTORS + 18
.equ TUTOR_SPECIAL_SHOCKWAVE,       NUM_MOVE_TUTORS + 19
.equ TUTOR_SPECIAL_PARABOLICCHARGE, NUM_MOVE_TUTORS + 20
.equ TUTOR_SPECIAL_COTTONSPORE,     NUM_MOVE_TUTORS + 21
.equ TUTOR_SPECIAL_FORESTSCURSE,    NUM_MOVE_TUTORS + 22
.equ TUTOR_SPECIAL_MEGADRAIN,       NUM_MOVE_TUTORS + 23
.equ TUTOR_SPECIAL_ICESHARD,        NUM_MOVE_TUTORS + 24
.equ TUTOR_SPECIAL_FREEZEDRY,       NUM_MOVE_TUTORS + 25
.equ TUTOR_SPECIAL_AURORABEAM,      NUM_MOVE_TUTORS + 26
.equ TUTOR_SPECIAL_KARATECHOP,      NUM_MOVE_TUTORS + 27
.equ TUTOR_SPECIAL_VACUUMWAVE,      NUM_MOVE_TUTORS + 28
.equ TUTOR_SPECIAL_STORMTHROW,      NUM_MOVE_TUTORS + 29
.equ TUTOR_SPECIAL_SLUDGE,          NUM_MOVE_TUTORS + 30
.equ TUTOR_SPECIAL_ACIDSPRAY,       NUM_MOVE_TUTORS + 31
.equ TUTOR_SPECIAL_COIL,            NUM_MOVE_TUTORS + 32
.equ TUTOR_SPECIAL_MUDSHOT,         NUM_MOVE_TUTORS + 33
.equ TUTOR_SPECIAL_SPIKES,          NUM_MOVE_TUTORS + 34
.equ TUTOR_SPECIAL_MAGNITUDE,       NUM_MOVE_TUTORS + 35
.equ TUTOR_SPECIAL_CHATTER,         NUM_MOVE_TUTORS + 36
.equ TUTOR_SPECIAL_PLUCK,           NUM_MOVE_TUTORS + 37
.equ TUTOR_SPECIAL_SKYDROP,         NUM_MOVE_TUTORS + 38
.equ TUTOR_SPECIAL_HEALBLOCK,       NUM_MOVE_TUTORS + 39
.equ TUTOR_SPECIAL_PSYWAVE,         NUM_MOVE_TUTORS + 40
.equ TUTOR_SPECIAL_MAGICPOWDER,     NUM_MOVE_TUTORS + 41
.equ TUTOR_SPECIAL_FURYCUTTER,      NUM_MOVE_TUTORS + 42
.equ TUTOR_SPECIAL_FELLSTINGER,     NUM_MOVE_TUTORS + 43
.equ TUTOR_SPECIAL_RAGEPOWDER,      NUM_MOVE_TUTORS + 44
.equ TUTOR_SPECIAL_ROLLOUT,         NUM_MOVE_TUTORS + 45
.equ TUTOR_SPECIAL_WIDEGUARD,       NUM_MOVE_TUTORS + 46
.equ TUTOR_SPECIAL_ANCIENTPOWER,    NUM_MOVE_TUTORS + 47
.equ TUTOR_SPECIAL_DESTINYBOND,     NUM_MOVE_TUTORS + 48
.equ TUTOR_SPECIAL_SHADOWSNEAK,     NUM_MOVE_TUTORS + 49
.equ TUTOR_SPECIAL_GRUDGE,          NUM_MOVE_TUTORS + 50
.equ TUTOR_SPECIAL_BREAKINGSWIPE,   NUM_MOVE_TUTORS + 51
.equ TUTOR_SPECIAL_SCALESHOT,       NUM_MOVE_TUTORS + 52
.equ TUTOR_SPECIAL_DRAGONRUSH,      NUM_MOVE_TUTORS + 53
.equ TUTOR_SPECIAL_FAKETEARS,       NUM_MOVE_TUTORS + 54
.equ TUTOR_SPECIAL_SUCKERPUNCH,     NUM_MOVE_TUTORS + 55
.equ TUTOR_SPECIAL_PURSUIT,         NUM_MOVE_TUTORS + 56
.equ TUTOR_SPECIAL_AUTOMIZE,        NUM_MOVE_TUTORS + 57
.equ TUTOR_SPECIAL_METALBURST,      NUM_MOVE_TUTORS + 58
.equ TUTOR_SPECIAL_HEAVYSLAM,       NUM_MOVE_TUTORS + 59
.equ TUTOR_SPECIAL_CRAFTYSHIELD,    NUM_MOVE_TUTORS + 60
.equ TUTOR_SPECIAL_DRAININGKISS,    NUM_MOVE_TUTORS + 61
.equ TUTOR_SPECIAL_SPIRITBREAK,     NUM_MOVE_TUTORS + 62
