...
extern const u8 BattleText_WithdrewPkmn_BattleSands[];
extern const u8 BattleText_SaysGo_BattleSands[];
extern const u8 BattleText_MealActivated[];
extern const u8 BattleText_BattleSandsBoost[];
...
extern const u8 sText_MegaRing[];
