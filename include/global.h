...
enum
{
	OPTIONS_AMETHYST_NORMAL_DIFFICULTY,
	OPTIONS_AMETHYST_HARD_DIFFICULTY,
	OPTIONS_AMETHYST_EXTRA_HARD_DIFFICULTY,
};

enum
{
	OPTIONS_AMETHYST_SOFT_LEVEL_CAPS,
	OPTIONS_AMETHYST_HARD_LEVEL_CAPS,
	OPTIONS_AMETHYST_EXTRA_HARD_LEVEL_CAPS,
};

enum //Selects a row of sBoostedStepTiers in overworld_speed.c
{
	OPTIONS_OVERWORLD_SPEED_NORMAL,
	OPTIONS_OVERWORLD_SPEED_2X,
	OPTIONS_OVERWORLD_SPEED_3X,
	OPTIONS_OVERWORLD_SPEED_4X,
	OPTIONS_OVERWORLD_SPEED_COUNT,
};

enum //Battle steps run per V-Blank is the value + 1
{
	OPTIONS_BATTLE_SPEED_NORMAL,
	OPTIONS_BATTLE_SPEED_2X,
	OPTIONS_BATTLE_SPEED_3X,
	OPTIONS_BATTLE_SPEED_4X,
	OPTIONS_BATTLE_SPEED_COUNT,
};
