...
#define VAR_TITLE_DEFENSE_VICTORIES 0x40AA
...
#define VAR_DAILY_SLOWPOKE_NEWS_DEX_NUMBER 0x40ED
#define VAR_DAILY_SLOWPOKE_NEWS_SPECIES 0x40EE
#define VAR_DAILY_SLOWPOKE_NEWS_REWARD_LEVEL 0x40EF
