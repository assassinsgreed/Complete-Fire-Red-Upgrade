...
enum
{
	CLASS_PKMN_TRAINER_1,	//0x0 Used by Casey
	CLASS_PKMN_TRAINER_2,	//0x1 Used by normal trainers
	CLASS_SENSEI,			//0x2
	CLASS_DISCIPLE,			//0x3
	...
	CLASS_PKMN_TRAINER_3,	//0x2C Used by trainer houses
	CLASS_PKMN_BREEDER_RS,	//0x2D
	CLASS_PKMN_RANGER_RS,	//0x2E
	CLASS_DEVELOPER,		//0x2F
	CLASS_GYM_TRAINEE,		//0x30
	CLASS_LASS_RS,			//0x31
	CLASS_BUG_CATCHER_RS,	//0x32
	CLASS_HIKER_RS,			//0x33
	CLASS_BATTLE_FRONTIER_BRAIN_RS,	//0x34 (Unused; was Young Couple)
	CLASS_OLD_COUPLE,		//0x35
	CLASS_SIS_AND_BRO_RS,	//0x36
	CLASS_TEAM_PLUTO_ADMIN,	//0x37
	CLASS_TEAM_PLUTO_LEADER, //0x38
	...
	CLASS_TWINS, 			//0x5C
	CLASS_BATTLE_FRONTIER_ACE, //0x5D
	CLASS_BATTLE_FRONTIER_BRAIN, //0x5E
