...
#define MAP_UNUSED_RUBARR_DESERT                 (2 | (1 << 8))
...
#define MAP_PROFESSORS_CONSERVATORY_GRASS        (47 | (3 << 8))
#define MAP_PROFESSORS_CONSERVATORY_FIRE         (48 | (3 << 8))
#define MAP_PROFESSORS_CONSERVATORY_WATER        (49 | (3 << 8))
