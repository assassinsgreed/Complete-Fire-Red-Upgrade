...
#define BATTLE_TYPE_FRONTIER			(BATTLE_TYPE_BATTLE_TOWER | BATTLE_TYPE_BATTLE_SANDS | BATTLE_TYPE_BATTLE_SIM)
...
#define BATTLE_SIM_ELECTRIC_TERRAIN		0x1 		//Field Effects
#define BATTLE_SIM_GRASSY_TERRAIN		0x2
#define BATTLE_SIM_MISTY_TERRAIN		0x4
#define BATTLE_SIM_PSYCHIC_TERRAIN		0x8
#define BATTLE_SIM_RAIN					0x10
#define BATTLE_SIM_SUN					0x20
#define BATTLE_SIM_SANDSTORM			0x40
#define BATTLE_SIM_HAIL					0x80
#define BATTLE_SIM_DELTA_STREAM			0x100
#define BATTLE_SIM_TRICK_ROOM 			0x200
#define BATTLE_SIM_MAGIC_ROOM			0x400
#define BATTLE_SIM_WONDER_ROOM			0x800
#define BATTLE_SIM_GRAVITY				0x1000
#define BATTLE_SIM_MAGNET_RISE			0x2000
#define BATTLE_SIM_FAIRY_LOCK			0x4000
#define BATTLE_SIM_PIXIES				0x8000
#define BATTLE_SIM_BAD_THOUGHTS			0x10000
#define BATTLE_SIM_INVERSE				0x20000
#define BATTLE_SIM_DYNAMAX				0x40000
#define BATTLE_SIM_TRADE_MON			0x80000 //Side Effects
#define BATTLE_SIM_SAFEGUARD			0x100000 
#define BATTLE_SIM_MIST					0x200000
#define BATTLE_SIM_SEA_OF_FIRE			0x400000	
#define BATTLE_SIM_RAINBOW				0x800000
#define BATTLE_SIM_CONFUSED				0x1000000 //Personal Effects
#define BATTLE_SIM_TAUNT				0x2000000
#define BATTLE_SIM_TORMENT				0x4000000
#define BATTLE_SIM_HEAL_BLOCK			0x8000000
#define BATTLE_SIM_THROAT_CHOP			0x10000000
#define BATTLE_SIM_ALWAYS_CRIT			0x20000000
#define BATTLE_SIM_NO_CRITS				0x40000000
#define BATTLE_SIM_ABILITY_SUPPRESSION	0x80000000

#define BATTLE_SIM_WEATHER (BATTLE_SIM_RAIN | BATTLE_SIM_SUN | BATTLE_SIM_SANDSTORM | BATTLE_SIM_HAIL | BATTLE_SIM_DELTA_STREAM)
#define BATTLE_SIM_TERRAIN (BATTLE_SIM_ELECTRIC_TERRAIN | BATTLE_SIM_GRASSY_TERRAIN | BATTLE_SIM_MISTY_TERRAIN | BATTLE_SIM_PSYCHIC_TERRAIN)
#define BATTLE_SIM_CRIT_EFFECT (BATTLE_SIM_ALWAYS_CRIT | BATTLE_SIM_NO_CRITS)
#define FIRST_BATTLE_SIM_SIDE_EFFECT_FLAG BATTLE_SIM_TRADE_MON
#define LAST_BATTLE_SIM_SIDE_EFFECT_FLAG BATTLE_SIM_RAINBOW
#define FIRST_BATTLE_SIM_PERSONAL_EFFECT_FLAG BATTLE_SIM_CONFUSED
#define LAST_BATTLE_SIM_FLAG BATTLE_SIM_ABILITY_SUPPRESSION
