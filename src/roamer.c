...
static const u8 sRoamerLocations[][NUM_MAPS_IN_SET] = //0x8466C58 in FR
{
	...
	{MAP_NUM(ROUTE_4),	MAP_NUM(ROUTE_3),	MAP_NUM(ROUTE_5),	MAP_NUM(ROUTE_13),	MAP_NUM(ROUTE_11),   MAP_NUM(RUBARR_DESERT), 0xFF},
	{MAP_NUM(ROUTE_5),	MAP_NUM(ROUTE_4),	MAP_NUM(ROUTE_11),	MAP_NUM(HELEO_RANCH_EXTERIOR),	MAP_NUM(ROUTE_6),	0xFF,	0xFF},
	...
	{MAP_NUM(ROUTE_9),  MAP_NUM(DAIMYN_CITY),	MAP_NUM(DAIMYN_CITY_FACTORY),	MAP_NUM(ROUTE_12),   MAP_NUM(ROUTE_10), MAP_NUM(ROUTE_6), MAP_NUM(ROUTE_8)},
	{MAP_NUM(ROUTE_10), MAP_NUM(DAIMYN_CITY),	MAP_NUM(DAIMYN_CITY_FACTORY),   MAP_NUM(HELEO_RANCH_EXTERIOR), MAP_NUM(ROUTE_11), 0xFF, 0xFF},
	{MAP_NUM(ROUTE_11), MAP_NUM(ROUTE_10),   MAP_NUM(ROUTE_11_NORTH),   0xFF,   0xFF, 0xFF, 0xFF},
	{MAP_NUM(ROUTE_11_NORTH), MAP_NUM(ROUTE_11),   0xFF,   0xFF, 0xFF, 0xFF, 0xFF},
	{MAP_NUM(ROUTE_12), MAP_NUM(ROUTE_9),   0xFF,   0xFF,   0xFF, 0xFF, 0xFF},
	...
	{MAP_NUM(ROUTE_24), MAP_NUM(ROUTE_25),   0xFF,   0xFF,   0xFF, 0xFF, 0xFF},
	{MAP_NUM(ROUTE_25), MAP_NUM(ROUTE_24),   0xFF,   0xFF,   0xFF, 0xFF, 0xFF},
