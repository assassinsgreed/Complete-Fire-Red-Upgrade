...
static const u8 sMainlandRoamerLocations[][NUM_MAPS_IN_SET] = //0x8466C58 in FR
{
	...
	{MAP_NUM(ROUTE_24), MAP_NUM(UTEYAN_RUINS_OVERWORLD),   MAP_NUM(ROUTE_11_SOUTH),   0xFF,   0xFF, 0xFF, 0xFF},
{MAP_NUM(ROUTE_24), MAP_NUM(UTEYAN_RUINS_OVERWORLD),   0xFF,   0xFF,   0xFF, 0xFF, 0xFF},
