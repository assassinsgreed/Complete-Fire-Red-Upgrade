...
#define FLAG_DISABLE_OBEDIENCE_CHECKS 0x94C // If set, obedience checks are skipped. Only set when entering New Game Plus.
...
#define BASE_POKE_CHIP_RATE 20 //The rate at which PokeChips can be found on wild Pokemon, when defeated
#define ENHANCED_POKE_CHIP_RATE 45 //The rate at which PokeChips can be found on wild Pokemon, when defeated and while holding the PokeChip Charm
...
#define MB_LAVA 0xA7 //The tile behavior byte for surfing on lava (requires a fire type or Groudon)
