...
{
	static const item_t sBallItemIds[] = {
		[BALL_TYPE_MASTER_BALL]  = ITEM_MASTER_BALL,
		[BALL_TYPE_ULTRA_BALL]   = ITEM_ULTRA_BALL,
		[BALL_TYPE_GREAT_BALL]   = ITEM_GREAT_BALL,
		[BALL_TYPE_POKE_BALL]    = ITEM_POKE_BALL,
		[BALL_TYPE_SAFARI_BALL]  = ITEM_SAFARI_BALL,
		[BALL_TYPE_NET_BALL]     = ITEM_NET_BALL,
		[BALL_TYPE_DIVE_BALL]    = ITEM_DIVE_BALL,
		[BALL_TYPE_NEST_BALL]    = ITEM_NEST_BALL,
		[BALL_TYPE_REPEAT_BALL]  = ITEM_REPEAT_BALL,
		[BALL_TYPE_TIMER_BALL]   = ITEM_TIMER_BALL,
		[BALL_TYPE_LUXURY_BALL]  = ITEM_LUXURY_BALL,
		[BALL_TYPE_PREMIER_BALL] = ITEM_PREMIER_BALL,
		[BALL_TYPE_DUSK_BALL]    = ITEM_DUSK_BALL,
		[BALL_TYPE_HEAL_BALL]    = ITEM_HEAL_BALL,
		[BALL_TYPE_QUICK_BALL]   = ITEM_QUICK_BALL,
		[BALL_TYPE_CHERISH_BALL] = ITEM_CHERISH_BALL,
		[BALL_TYPE_PARK_BALL]    = ITEM_PARK_BALL,
		[BALL_TYPE_FAST_BALL]    = ITEM_FAST_BALL,
		[BALL_TYPE_LEVEL_BALL]   = ITEM_LEVEL_BALL,
		[BALL_TYPE_LURE_BALL]    = ITEM_LURE_BALL,
		[BALL_TYPE_HEAVY_BALL]   = ITEM_HEAVY_BALL,
		[BALL_TYPE_LOVE_BALL]    = ITEM_LOVE_BALL,
		[BALL_TYPE_FRIEND_BALL]  = ITEM_FRIEND_BALL,
		[BALL_TYPE_MOON_BALL]    = ITEM_MOON_BALL,
		[BALL_TYPE_SPORT_BALL]   = ITEM_SPORT_BALL,
		[BALL_TYPE_BEAST_BALL]   = ITEM_BEAST_BALL,
		[BALL_TYPE_DREAM_BALL]   = ITEM_DREAM_BALL,
	};

	if (ballId >= ARRAY_COUNT(sBallItemIds))
		return ITEM_POKE_BALL;

	return sBallItemIds[ballId];
}
