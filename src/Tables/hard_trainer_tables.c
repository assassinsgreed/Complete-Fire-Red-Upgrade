...
// NOTE: The trainers here are ovverides for those found in traner_tables.c for the Hard Mode difficulty. If a trainer is not present here, the standard difficulty trainer is loaded instead.
...
const struct TrainerMonItemCustomMoves sParty_Rival2_Hard[] = {
    {
        .lvl = 12,
        .species = SPECIES_ROOKIDEE,
        .moves = { MOVE_FURYATTACK, MOVE_HONECLAWS, MOVE_PECK, MOVE_ROCKSMASH },
    ...
    },
    {
        ...
        .moves = { MOVE_PECK, MOVE_FURYCUTTER, MOVE_FINALGAMBIT, MOVE_LEER },
        .heldItem = ITEM_LEEK,
...
const struct TrainerMonItemCustomMoves sParty_PartnerRival1_Hard[] = {
    {
        .lvl = 13,
        .species = SPECIES_ROOKIDEE,
        .moves = { MOVE_FURYATTACK, MOVE_HONECLAWS, MOVE_PECK, MOVE_ROCKSMASH },
...
const struct TrainerMonItemCustomMoves sParty_Rival3_Hard[] = {
    {
        .lvl = 30,
        .species = SPECIES_CORVISQUIRE,
        .moves = { MOVE_TAUNT, MOVE_PLUCK, MOVE_TAILWIND, MOVE_FURYATTACK },
        .heldItem = ITEM_SILK_SCARF,
        .ability = Ability_1 // Keen Eye 
    },
    {
        .lvl = 30,
        .species = SPECIES_FARFETCHD_G,
        .moves = { MOVE_KNOCKOFF, MOVE_BRICKBREAK, MOVE_PECK, MOVE_FURYCUTTER },
        .heldItem = ITEM_LEEK,
        .ability = Ability_1 // Steadfast
    },
    {
        ...
        .moves = { MOVE_ELECTROBALL, MOVE_THUNDERWAVE, MOVE_FIREPUNCH, MOVE_TAKEDOWN },
    ...
    },
    {
        .lvl = 32,
        .species = SPECIES_EEVEE,
        .moves = { MOVE_BITE, MOVE_COVET, MOVE_DOUBLEKICK, MOVE_TICKLE },
        .heldItem = ITEM_BERRY_JUICE,
        .ability = Ability_2 // Adaptability
    }
};

const struct TrainerMonItemCustomMoves sParty_Casey1_Hard[] = {
    {
        .lvl = 15,
        .species = SPECIES_ELGYEM,
        .moves = { MOVE_CONFUSION, MOVE_GROWL, MOVE_DESTINYBOND, MOVE_DISABLE},
    ...
    },
    {
        ...
        .moves = { MOVE_FACADE, MOVE_LOWKICK, MOVE_PAYBACK, MOVE_FAKEOUT },
    ...
    },
    {
        ...
        .moves = { MOVE_OCTAZOOKA, MOVE_SMOKESCREEN, MOVE_FOCUSENERGY, MOVE_SCALESHOT },
        .heldItem = ITEM_SITRUS_BERRY,
        .ability = Ability_2 // Sniper
    }
};

const struct TrainerMonItemCustomMoves sParty_Casey2_Hard[] = {
    {
        .lvl = 34,
        .species = SPECIES_ELGYEM,
        .moves = { MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_COSMICPOWER, MOVE_AGILITY },
        .heldItem = ITEM_EVIOLITE,
        .ability = Ability_2 // Synchronize
    },
    {
        .lvl = 34,
        .species = SPECIES_SCRAGGY,
        .moves = { MOVE_FACADE, MOVE_BRICKBREAK, MOVE_KNOCKOFF, MOVE_DRAINPUNCH },
        .heldItem = ITEM_TOXIC_ORB,
        .ability = Ability_Hidden // Intimidate
    },
    {
        ...
        .moves = { MOVE_FOCUSENERGY, MOVE_MUDDYWATER, MOVE_ICEBEAM, MOVE_CLEARSMOG },
        .heldItem = ITEM_SCOPE_LENS,
        .ability = Ability_2 // Sniper
    }
};

const struct TrainerMonItemCustomMoves sParty_Rival4_Vaporeon_Hard[] = {
    {
        .lvl = 36,
        .species = SPECIES_CORVISQUIRE,
...
const struct TrainerMonItemCustomMoves sParty_Rival4_Jolteon_Hard[] = {
    {
        .lvl = 36,
        .species = SPECIES_CORVISQUIRE,
        .moves = { MOVE_DRILLPECK, MOVE_ROCKSMASH, MOVE_TAILWIND, MOVE_TAUNT },
...
const struct TrainerMonItemCustomMoves sParty_Rival4_Flareon_Hard[] = {
    {
        .lvl = 36,
        .species = SPECIES_CORVISQUIRE,
        .moves = { MOVE_DRILLPECK, MOVE_ROCKSMASH, MOVE_TAILWIND, MOVE_TAUNT },
...
const struct TrainerMonItemCustomMoves sParty_Rival4_Espeon_Hard[] = {
    {
        .lvl = 36,
        .species = SPECIES_CORVISQUIRE,
        .moves = { MOVE_DRILLPECK, MOVE_ROCKSMASH, MOVE_TAILWIND, MOVE_TAUNT },
...
const struct TrainerMonItemCustomMoves sParty_Rival4_Umbreon_Hard[] = {
    {
        .lvl = 36,
        .species = SPECIES_CORVISQUIRE,
        .moves = { MOVE_DRILLPECK, MOVE_ROCKSMASH, MOVE_TAILWIND, MOVE_TAUNT },
...
const struct TrainerMonItemCustomMoves sParty_Rival4_Leafeon_Hard[] = {
    {
        .lvl = 36,
        .species = SPECIES_CORVISQUIRE,
        .moves = { MOVE_DRILLPECK, MOVE_ROCKSMASH, MOVE_TAILWIND, MOVE_TAUNT },
...
const struct TrainerMonItemCustomMoves sParty_Rival4_Glaceon_Hard[] = {
    {
        .lvl = 36,
        .species = SPECIES_CORVISQUIRE,
        .moves = { MOVE_DRILLPECK, MOVE_ROCKSMASH, MOVE_TAILWIND, MOVE_TAUNT },
...
const struct TrainerMonItemCustomMoves sParty_Rival4_Sylveon_Hard[] = {
    {
        .lvl = 36,
        .species = SPECIES_CORVISQUIRE,
        .moves = { MOVE_DRILLPECK, MOVE_ROCKSMASH, MOVE_TAILWIND, MOVE_TAUNT },
...
const struct TrainerMonItemCustomMoves sParty_Rival5_Vaporeon_Hard[] = {
    {
        .lvl = 45,
...
const struct TrainerMonItemCustomMoves sParty_Rival5_Jolteon_Hard[] = {
    {
        .lvl = 45,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_ROOST, MOVE_IRONDEFENSE, MOVE_IRONHEAD },
...
const struct TrainerMonItemCustomMoves sParty_Rival5_Flareon_Hard[] = {
    {
        .lvl = 45,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_ROOST, MOVE_IRONDEFENSE, MOVE_IRONHEAD },
...
const struct TrainerMonItemCustomMoves sParty_Rival5_Espeon_Hard[] = {
    {
        .lvl = 45,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_ROOST, MOVE_IRONDEFENSE, MOVE_IRONHEAD },
...
const struct TrainerMonItemCustomMoves sParty_Rival5_Umbreon_Hard[] = {
    {
        .lvl = 45,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_ROOST, MOVE_IRONDEFENSE, MOVE_IRONHEAD },
...
const struct TrainerMonItemCustomMoves sParty_Rival5_Leafeon_Hard[] = {
    {
        .lvl = 45,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_ROOST, MOVE_IRONDEFENSE, MOVE_IRONHEAD },
...
const struct TrainerMonItemCustomMoves sParty_Rival5_Glaceon_Hard[] = {
    {
        .lvl = 45,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_ROOST, MOVE_IRONDEFENSE, MOVE_IRONHEAD },
...
const struct TrainerMonItemCustomMoves sParty_Rival5_Sylveon_Hard[] = {
    {
        .lvl = 45,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_ROOST, MOVE_IRONDEFENSE, MOVE_IRONHEAD },
...
const struct TrainerMonItemCustomMoves sParty_Rival_EmraldinQuayEvent_Hard[] = {
    {
        .lvl = 51,
...
const struct TrainerMonItemCustomMoves sParty_CarnelidgeVolcano_Rival_Hard[] = {
    {
        .lvl = 54,
        .species = SPECIES_CORVIKNIGHT,
...
const struct TrainerMonItemCustomMoves sParty_CarnelidgeVolcano_PartnerRival_Hard[] = {
    {
        .lvl = 54,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_CarnelidgeVolcano_Alistair_Hard[] = {
    {
        .lvl = 56,
...
const struct TrainerMonItemCustomMoves sParty_VictoryRoad_Rival_Vaporeon_Hard[] = {
    {
        .lvl = 66,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_VictoryRoad_Rival_Jolteon_Hard[] = {
    {
        .lvl = 66,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_VictoryRoad_Rival_Flareon_Hard[] = {
    {
        .lvl = 66,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_VictoryRoad_Rival_Espeon_Hard[] = {
    {
        .lvl = 66,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_VictoryRoad_Rival_Umbreon_Hard[] = {
    {
        .lvl = 66,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_VictoryRoad_Rival_Leafeon_Hard[] = {
    {
        .lvl = 66,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_VictoryRoad_Rival_Glaceon_Hard[] = {
    {
        .lvl = 66,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_VictoryRoad_Rival_Sylveon_Hard[] = {
    {
        .lvl = 66,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_Rival_ExhibitionBattle_SecondaryTeam_Hard[] = {
    {
        .lvl = 66,
        .species = SPECIES_CLOYSTER,
        .moves = { MOVE_SPIKES, MOVE_TOXICSPIKES, MOVE_RAZORSHELL, MOVE_ICICLECRASH },
...
const struct TrainerMonItemCustomMoves sParty_PostCredits_Alistair_Hard[] = {
    {
        .lvl = 72,
...
const struct TrainerMonItemCustomMoves sParty_Rival_PostgameExhibitionBattle_Vaporeon_Hard[] = {
    {
        .lvl = 71,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_Rival_PostgameExhibitionBattle_Jolteon_Hard[] = {
    {
        .lvl = 71,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_Rival_PostgameExhibitionBattle_Flareon_Hard[] = {
    {
        .lvl = 71,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_Rival_PostgameExhibitionBattle_Espeon_Hard[] = {
    {
        .lvl = 71,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_Rival_PostgameExhibitionBattle_Umbreon_Hard[] = {
    {
        .lvl = 71,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_Rival_PostgameExhibitionBattle_Leafeon_Hard[] = {
    {
        .lvl = 71,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_Rival_PostgameExhibitionBattle_Glaceon_Hard[] = {
    {
        .lvl = 71,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_Rival_PostgameExhibitionBattle_Sylveon_Hard[] = {
    {
        .lvl = 71,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_BRAVEBIRD, MOVE_IRONHEAD, MOVE_IRONDEFENSE, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_Rival_PostgameExhibitionBattle_SecondaryTeam_Hard[] = {
    {
        .lvl = 71,
        .species = SPECIES_CLOYSTER,
        .moves = { MOVE_SPIKES, MOVE_TOXICSPIKES, MOVE_RAZORSHELL, MOVE_ICICLECRASH },
...
const struct TrainerMonItemCustomMoves sParty_RhodanziCity_LeaderTerrence_Hard[] = {
    {
        .lvl = 12,
...
const struct TrainerMonItemCustomMoves sParty_RubarrDesert_TeamPlutoAdminIrene_Hard[] = {
    {
        .lvl = 14,
        .species = SPECIES_NICKIT,
...
const struct TrainerMonItemCustomMoves sParty_FerroxGym_GymLeaderStella_Hard[] = {
    {
        .lvl = 19,
...
// #region Heleo City
const struct TrainerMonItemCustomMoves sParty_HeleoCityGym_LeaderRaine_Hard[] = {
    {
        .lvl = 26,
...
const struct TrainerMonItemCustomMoves sParty_HeleoCityGym_LeaderRaine2_Hard[] = {
    {
        .lvl = 32,
        .species = SPECIES_PELIPPER,
...
const struct TrainerMonItemCustomMoves sParty_HeleoCityGym_LeaderRaine3_Hard[] = {
    {
        .lvl = 40,
        .species = SPECIES_PELIPPER,
...
// #region Daimyn City
const struct TrainerMonItemCustomMoves sParty_DaimynCityGym_LeaderChance_Hard[] = {
    {
        .lvl = 32,
...
const struct TrainerMonItemCustomMoves sParty_DaimynCityGym_LeaderChance2_Hard[] = {
    {
        .lvl = 40,
        .species = SPECIES_MINIOR_SHIELD,
        .moves = { MOVE_REFLECT, MOVE_LIGHTSCREEN, MOVE_UTURN, MOVE_ANCIENTPOWER },
...
const struct TrainerMonItemCustomMoves sParty_Route11South_TeamPlutoAdminRonald_Hard[] = {
    {
        .lvl = 36,
...
// #region Laplaz Town
const struct TrainerMonItemCustomMoves sParty_LaplazTownGym_LeaderCasey_Hard[] = {
    {
        .lvl = 40,
...
// #region Scalding Spa
const struct TrainerMonItemCustomMoves sParty_ScaldingSpa_TeamPlutoYolena_Hard[] = {
    {
        .lvl = 42,
...
const struct TrainerMonItemCustomMoves sParty_BruccieVillageGym_LeaderAbby_Hard[] = {
    {
        .lvl = 46,
...
const struct TrainerMonItemCustomMoves sParty_CalicinBay_TeamPlutoYolena_Hard[] = {
    {
        .lvl = 46,
        .species = SPECIES_TOXICROAK,
        .moves = { MOVE_POISONJAB, MOVE_VENOSHOCK, MOVE_PROTECT, MOVE_DRAINPUNCH },
...
// #region Pluto HQ
const struct TrainerMonItemCustomMoves sParty_PlutoHQ_B4F_TeamPlutoAdminIrene_Hard[] = {
    {
        .lvl = 48,
...
const struct TrainerMonItemCustomMoves sParty_PlutoHQ_B7F_TeamPlutoAdminRonald_Hard[] = {
    {
        .lvl = 48,
...
const struct TrainerMonItemCustomMoves sParty_PlutoHQ_B1F_TeamPlutoLeaderKurtis_Hard[] = {
    {
        .lvl = 50,
        .species = SPECIES_AMOONGUSS,
...
const struct TrainerMonNoItemCustomMoves sParty_TsarvosaCity_StatsDojo_Kaito_Hard[] = {
    {
        .lvl = 52,
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_DevTeam_Collin1_Hard[] = {
    {
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_DevTeam_Collin2_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_DevTeam_Crystal1_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
        .species = SPECIES_TOGEKISS,
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_DevTeam_Crystal2_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
        .species = SPECIES_EMBOAR,
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Noam_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Ashley_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Chelsea_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Buddy_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Gawain_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
        .species = SPECIES_FALINKS,
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Skylar_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Bella_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
        .species = SPECIES_CROBAT,
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Flash_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Terra_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Seifa_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
        .species = SPECIES_MALAMAR,
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Rocco_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Janice_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
        .species = SPECIES_CLOYSTER,
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Antoinette_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Ryu_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
        .species = SPECIES_TURTONATOR,
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Caspar_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
        .species = SPECIES_JELLICENT,
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Darcy_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
        .species = SPECIES_WEAVILE,
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Mason_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCity_GymTrainees_Faye_Hard[] = {
    {
        .lvl = 50, // Minimum, scales to player
...
const struct TrainerMonItemCustomMoves sParty_TsarvosaCityGym_LeaderIris_Hard[] = {
    {
        .lvl = 56,
        .species = SPECIES_FERROTHORN,
...
const struct TrainerMonItemCustomMoves sParty_DaimynCityRestaurant_Iris_Hard[] = {
    {
        .lvl = 58,
        .species = SPECIES_FERROTHORN,
...
const struct TrainerMonItemCustomMoves sParty_DaimynCityRestaurant_Stella_Hard[] = {
    {
        .lvl = 57,
        .species = SPECIES_TOXAPEX,
...
const struct TrainerMonItemCustomMoves sParty_UteyaVillageGym_LeadersDennisAndDee_Hard[] = {
    {
        .lvl = 62,
        .species = SPECIES_KLINKLANG,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_EliteFour_Hannah_Hard[] = {
    {
        .lvl = 67,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_EliteFour_Lucas_Hard[] = {
    {
        .lvl = 68,
        .species = SPECIES_FERROTHORN,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_EliteFour_Jenna_Hard[] = {
    {
        .lvl = 69,
        .species = SPECIES_TOXAPEX,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_EliteFour_Thomas_Hard[] = {
    {
        .lvl = 70,
        .species = SPECIES_VENUSAUR,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_Champion_Selene_Hard[] = {
    {
        .lvl = 72,
        .species = SPECIES_SKARMORY,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_EliteFour_HannahRematch_Hard[] = {
    {
        .lvl = 72,
        .species = SPECIES_WHIMSICOTT,
        .moves = { MOVE_LEECHSEED, MOVE_SUBSTITUTE, MOVE_COTTONGUARD, MOVE_GIGADRAIN },
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_EliteFour_LucasRematch_Hard[] = {
    {
        .lvl = 72,
        .species = SPECIES_FERROTHORN,
        .moves = { MOVE_LEECHSEED, MOVE_SPIKES, MOVE_POWERWHIP, MOVE_GYROBALL },
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_EliteFour_JennaRematch_Hard[] = {
    {
        .lvl = 72,
        .species = SPECIES_TOXAPEX,
        .moves = { MOVE_TOXICSPIKES, MOVE_BANEFULBUNKER, MOVE_LIQUIDATION, MOVE_RECOVER },
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_EliteFour_ThomasRematch_Hard[] = {
    {
        .lvl = 72,
        .species = SPECIES_VENUSAUR,
        .moves = { MOVE_LEECHSEED, MOVE_SLUDGEBOMB, MOVE_SYNTHESIS, MOVE_GIGADRAIN },
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Rival_Vaporeon_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_CORVIKNIGHT,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Rival_Jolteon_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_IRONDEFENSE, MOVE_BODYPRESS, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Rival_Flareon_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_IRONDEFENSE, MOVE_BODYPRESS, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Rival_Espeon_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_IRONDEFENSE, MOVE_BODYPRESS, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Rival_Umbreon_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_IRONDEFENSE, MOVE_BODYPRESS, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Rival_Leafeon_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_IRONDEFENSE, MOVE_BODYPRESS, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Rival_Glaceon_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_IRONDEFENSE, MOVE_BODYPRESS, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Rival_Sylveon_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_CORVIKNIGHT,
        .moves = { MOVE_DRILLPECK, MOVE_IRONDEFENSE, MOVE_BODYPRESS, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_YoungsterJoey_Hard[] = {
    {
        .lvl = 78,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Selene_WithVictini_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_SKARMORY,
        .moves = { MOVE_BRAVEBIRD, MOVE_SPIKES, MOVE_IRONHEAD, MOVE_ROOST },
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Selene_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_FERROTHORN,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Alistair_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_CROBAT,
        .moves = { MOVE_ACROBATICS, MOVE_LEECHLIFE, MOVE_CROSSPOISON, MOVE_HAZE },
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Hawthorne_Hard[] = {
    {
        .lvl = 78,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Clancy_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_THIEVUL,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Ena_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_DUSKNOIR,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Felix_Hard[] = {
    {
        .lvl = 78,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Collin_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_CACTURNE,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Crystal_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_GALVANTULA,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Irene_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_NOCTOWL,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Ronald_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_KROOKODILE,
...
const struct TrainerMonItemCustomMoves sParty_AscensionTower_TitleDefense_Kurtis_Hard[] = {
    {
        .lvl = 78,
        .species = SPECIES_AMOONGUSS,
        .moves = { MOVE_CLEARSMOG, MOVE_SPORE, MOVE_SYNTHESIS, MOVE_SLUDGEBOMB },
...
const struct Trainer gHardTrainers[] = {
    ...
    [TRAINER_RIVAL2] = {
        ...
        .partySize = NELEMS(sParty_Rival2_Hard),
    ...
    [TRAINER_RUBARR_DESERT_PARTNER_RIVAL] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_PartnerRival1_Hard),
        .party = {.ItemCustomMoves = sParty_PartnerRival1_Hard}
    },
    [TRAINER_RIVAL3] = {
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES | PARTY_FLAG_HAS_ITEM,
        .trainerClass = CLASS_RIVAL,
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_Rival3_Hard),
        .party = {.ItemCustomMoves = sParty_Rival3_Hard}
    },
    [TRAINER_TORMA_CAVE_CASEY_F] = {
        ...
        .partySize = NELEMS(sParty_Casey1_Hard),
        .party = {.ItemCustomMoves = sParty_Casey1_Hard}
    },
    ...
    [TRAINER_ROUTE_10_CASEY_F] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Casey2_Hard),
        .party = {.ItemCustomMoves = sParty_Casey2_Hard}
    },
    ...
    [TRAINER_ROUTE_11_SOUTH_RIVAL_V] = {
        ...
        .partySize = NELEMS(sParty_Rival4_Vaporeon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival4_Vaporeon_Hard}
    },
    [TRAINER_ROUTE_11_SOUTH_RIVAL_J] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival4_Jolteon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival4_Jolteon_Hard}
    },
    [TRAINER_ROUTE_11_SOUTH_RIVAL_F] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival4_Flareon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival4_Flareon_Hard}
    },
    [TRAINER_ROUTE_11_SOUTH_RIVAL_E] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival4_Espeon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival4_Espeon_Hard}
    },
    [TRAINER_ROUTE_11_SOUTH_RIVAL_U] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival4_Umbreon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival4_Umbreon_Hard}
    },
    [TRAINER_ROUTE_11_SOUTH_RIVAL_L] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival4_Leafeon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival4_Leafeon_Hard}
    },
    [TRAINER_ROUTE_11_SOUTH_RIVAL_G] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival4_Glaceon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival4_Glaceon_Hard}
    },
    [TRAINER_ROUTE_11_SOUTH_RIVAL_S] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival4_Sylveon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival4_Sylveon_Hard}
    },
    [TRAINER_BRUCCIE_VILLAGE_RIVAL_V] = {
        ...
        .partySize = NELEMS(sParty_Rival5_Vaporeon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival5_Vaporeon_Hard}
    },
    [TRAINER_BRUCCIE_VILLAGE_RIVAL_J] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival5_Jolteon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival5_Jolteon_Hard}
    },
    [TRAINER_BRUCCIE_VILLAGE_RIVAL_F] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival5_Flareon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival5_Flareon_Hard}
    },
    [TRAINER_BRUCCIE_VILLAGE_RIVAL_E] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival5_Espeon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival5_Espeon_Hard}
    },
    [TRAINER_BRUCCIE_VILLAGE_RIVAL_U] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival5_Umbreon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival5_Umbreon_Hard}
    },
    [TRAINER_BRUCCIE_VILLAGE_RIVAL_L] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival5_Leafeon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival5_Leafeon_Hard}
    },
    [TRAINER_BRUCCIE_VILLAGE_RIVAL_G] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival5_Glaceon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival5_Glaceon_Hard}
    },
    [TRAINER_BRUCCIE_VILLAGE_RIVAL_S] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival5_Sylveon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival5_Sylveon_Hard}
    },
    [TRAINER_EMRALDIN_QUAY_OPTIONAL_RIVAL] = {
        ...
        .partySize = NELEMS(sParty_Rival_EmraldinQuayEvent_Hard),
        .party = {.ItemCustomMoves = sParty_Rival_EmraldinQuayEvent_Hard}
    },
    [TRAINER_CARNELIDGE_VOLCANO_RIVAL] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_CarnelidgeVolcano_Rival_Hard),
        .party = {.ItemCustomMoves = sParty_CarnelidgeVolcano_Rival_Hard}
    },
    [TRAINER_CARNELIDGE_VOLCANO_ALISTAIR] = {
        ...
        .partySize = NELEMS(sParty_CarnelidgeVolcano_Alistair_Hard),
        .party = {.ItemCustomMoves = sParty_CarnelidgeVolcano_Alistair_Hard}
    },
    // #endregion
    // #region Rhodanzi City
    [TRAINER_RHODANZI_GYM_LEADER_TERRENCE] = {
        ...
        .partySize = NELEMS(sParty_RhodanziCity_LeaderTerrence_Hard),
        .party = {.ItemCustomMoves = sParty_RhodanziCity_LeaderTerrence_Hard}
    },
    // #endregion
    // #region Rubarr Desert
    [TRAINER_RUBARR_DESERT_TEAM_PLUTO_ADMIN_IRENE] = {
        ...
        .partySize = NELEMS(sParty_RubarrDesert_TeamPlutoAdminIrene_Hard),
        .party = {.ItemCustomMoves = sParty_RubarrDesert_TeamPlutoAdminIrene_Hard}
    },
    // #endregion
    // #region Ferrox Gym
    [TRAINER_FERROX_GYM_LEADER_STELLA] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_HardBaseline,
        .partySize = NELEMS(sParty_FerroxGym_GymLeaderStella_Hard),
        .party = {.ItemCustomMoves = sParty_FerroxGym_GymLeaderStella_Hard}
    },
    // #endregion
    ...
    [TRAINER_HELEO_CITY_GYM_LEADER_RAINE] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_HardBaseline,
        .partySize = NELEMS(sParty_HeleoCityGym_LeaderRaine_Hard),
        .party = {.ItemCustomMoves = sParty_HeleoCityGym_LeaderRaine_Hard}
    },
    [TRAINER_HELEO_CITY_GYM_LEADER_RAINE_2] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_HardBaseline,
        .partySize = NELEMS(sParty_HeleoCityGym_LeaderRaine2_Hard),
        .party = {.ItemCustomMoves = sParty_HeleoCityGym_LeaderRaine2_Hard}
    },
    [TRAINER_HELEO_CITY_GYM_LEADER_RAINE_3] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_HardBaseline,
        .partySize = NELEMS(sParty_HeleoCityGym_LeaderRaine3_Hard),
        .party = {.ItemCustomMoves = sParty_HeleoCityGym_LeaderRaine3_Hard}
    },
    // #endregion
    ...
    [TRAINER_DAIMYN_CITY_GYM_LEADER_CHANCE] = {
        ...
        .partySize = NELEMS(sParty_DaimynCityGym_LeaderChance_Hard),
        .party = {.ItemCustomMoves = sParty_DaimynCityGym_LeaderChance_Hard}
    },
    [TRAINER_DAIMYN_CITY_GYM_LEADER_CHANCE_2] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_HardBaseline | AI_SCRIPT_SETUP_FIRST_TURN,
        .partySize = NELEMS(sParty_DaimynCityGym_LeaderChance2_Hard),
        .party = {.ItemCustomMoves = sParty_DaimynCityGym_LeaderChance2_Hard}
    },
    // #endregion
    // #region Route 11 South
    [TRAINER_ROUTE_11_SOUTH_PLUTO_ADMIN_RONALD] = {
        ...
        .partySize = NELEMS(sParty_Route11South_TeamPlutoAdminRonald_Hard),
        .party = {.ItemCustomMoves = sParty_Route11South_TeamPlutoAdminRonald_Hard}
    },
    // #endregion
    ...
    [TRAINER_LAPLAZ_GYM_LEADER_CASEY_F] = {
        ...
        .partySize = NELEMS(sParty_LaplazTownGym_LeaderCasey_Hard),
        .party = {.ItemCustomMoves = sParty_LaplazTownGym_LeaderCasey_Hard}
    },
    ...
    [TRAINER_SCALDING_SPA_TEAM_PLUTO_YOLENA] = {
        ...
        .partySize = NELEMS(sParty_ScaldingSpa_TeamPlutoYolena_Hard),
        .party = {.ItemCustomMoves = sParty_ScaldingSpa_TeamPlutoYolena_Hard}
    },
    // #endregion
    ...
    [TRAINER_BRUCCIE_VILLAGE_GYM_LEADER_ABBY] = {
        ...
        .partySize = NELEMS(sParty_BruccieVillageGym_LeaderAbby_Hard),
        .party = {.ItemCustomMoves = sParty_BruccieVillageGym_LeaderAbby_Hard}
    },
    // #endregion
    // #region Calicin Bay
    [TRAINER_CALICIN_BAY_TEAM_PLUTO_YOLENA] = {
        ...
        .doubleBattle = TRUE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_DOUBLE_BATTLE,
        .partySize = NELEMS(sParty_CalicinBay_TeamPlutoYolena_Hard),
        .party = {.ItemCustomMoves = sParty_CalicinBay_TeamPlutoYolena_Hard}
    },
    // #endregion
    // #region Pluto HQ
    [TRAINER_PLUTO_HQ_B4F_PLUTO_ADMIN_IRENE] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags =  AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_RISKY,
        .partySize = NELEMS(sParty_PlutoHQ_B4F_TeamPlutoAdminIrene_Hard),
        .party = {.ItemCustomMoves = sParty_PlutoHQ_B4F_TeamPlutoAdminIrene_Hard}
    },
    [TRAINER_PLUTO_HQ_B7F_PLUTO_ADMIN_RONALD] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags =  AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_RISKY,
        .partySize = NELEMS(sParty_PlutoHQ_B7F_TeamPlutoAdminRonald_Hard),
        .party = {.ItemCustomMoves = sParty_PlutoHQ_B7F_TeamPlutoAdminRonald_Hard}
    },
    [TRAINER_PLUTO_HQ_B1F_PLUTO_LEADER_KURTIS] = {
        ...
        .partySize = NELEMS(sParty_PlutoHQ_B1F_TeamPlutoLeaderKurtis_Hard),
        .party = {.ItemCustomMoves = sParty_PlutoHQ_B1F_TeamPlutoLeaderKurtis_Hard}
    },
    // #endregion
    // #region Tsarvosa City
    [TRAINER_TSARVOSA_CITY_STATS_DOJO_KAITO] = {
        ...
        .partySize = NELEMS(sParty_TsarvosaCity_StatsDojo_Kaito_Hard),
        .party = {.NoItemCustomMoves = sParty_TsarvosaCity_StatsDojo_Kaito_Hard}
    },
    [TRAINER_TSARVOSA_CITY_DEV_TEAM_COLLIN_1] = {
        ...
        .partySize = NELEMS(sParty_TsarvosaCity_DevTeam_Collin1_Hard),
        .party = {.ItemCustomMoves = sParty_TsarvosaCity_DevTeam_Collin1_Hard}
    },
    [TRAINER_TSARVOSA_CITY_DEV_TEAM_COLLIN_2] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_Developer_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_DevTeam_Collin2_Hard),
        .party = {.ItemCustomMoves = sParty_TsarvosaCity_DevTeam_Collin2_Hard}
    },
    [TRAINER_TSARVOSA_CITY_DEV_TEAM_CRYSTAL_1] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_Developer_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_DevTeam_Crystal1_Hard),
        .party = {.ItemCustomMoves = sParty_TsarvosaCity_DevTeam_Crystal1_Hard}
    },
    [TRAINER_TSARVOSA_CITY_DEV_TEAM_CRYSTAL_2] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_Developer_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_DevTeam_Crystal2_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_NOAM] = {
        ...
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Noam_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_ASHLEY] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Ashley_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_CHELSEA] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Chelsea_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_BUDDY] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Buddy_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_GAWAIN] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Gawain_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_SKYLAR] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Skylar_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_BELLA] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Bella_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_FLASH] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Flash_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_TERRA] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Terra_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_SEIFA] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Seifa_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_ROCCO] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Rocco_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_JANICE] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Janice_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_ANTOINETTE] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Antoinette_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_RYU] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Ryu_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_CASPAR] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Caspar_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_DARCY] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Darcy_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_MASON] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Mason_Hard),
    ...
    [TRAINER_TSARVOSA_CITY_GYM_TRAINEE_FAYE] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_GymTrainees_Hard,
        .partySize = NELEMS(sParty_TsarvosaCity_GymTrainees_Faye_Hard),
        .party = {.ItemCustomMoves = sParty_TsarvosaCity_GymTrainees_Faye_Hard}
    },
    [TRAINER_TSARVOSA_CITY_GYM_LEADER_IRIS] = {
        ...
        .partySize = NELEMS(sParty_TsarvosaCityGym_LeaderIris_Hard),
        .party = {.ItemCustomMoves = sParty_TsarvosaCityGym_LeaderIris_Hard}
    },
    // #endregion
    ...
    [TRAINER_DAIMYN_CITY_RESTAURANT_IRIS] = {
        ...
        .partySize = NELEMS(sParty_DaimynCityRestaurant_Iris_Hard),
        .party = {.ItemCustomMoves = sParty_DaimynCityRestaurant_Iris_Hard}
    },
    [TRAINER_DAIMYN_CITY_RESTAURANT_STELLA] = {
        ...
        .partySize = NELEMS(sParty_DaimynCityRestaurant_Stella_Hard),
        .party = {.ItemCustomMoves = sParty_DaimynCityRestaurant_Stella_Hard}
    },
    // #endregion
    ...
    [TRAINER_CARNELIDGE_VOLCANO_PARTNER_RIVAL] = {
        ...
        .partySize = NELEMS(sParty_CarnelidgeVolcano_PartnerRival_Hard),
        .party = {.ItemCustomMoves = sParty_CarnelidgeVolcano_PartnerRival_Hard}
    },
    // #endregion
    // #region Uteya Village
    [TRAINER_UTEYA_VILLAGE_GYM_LEADERS_DENNIS_AND_DEE] = {
        ...
        .partySize = NELEMS(sParty_UteyaVillageGym_LeadersDennisAndDee_Hard),
        .party = {.ItemCustomMoves = sParty_UteyaVillageGym_LeadersDennisAndDee_Hard}
    },
    // #endregion
    // #region Victory Road
    [TRAINER_VICTORY_ROAD_RIVAL_V] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_VictoryRoad_Rival_Vaporeon_Hard),
        .party = {.ItemCustomMoves = sParty_VictoryRoad_Rival_Vaporeon_Hard}
    },
    [TRAINER_VICTORY_ROAD_RIVAL_J] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_VictoryRoad_Rival_Jolteon_Hard),
        .party = {.ItemCustomMoves = sParty_VictoryRoad_Rival_Jolteon_Hard}
    },
    [TRAINER_VICTORY_ROAD_RIVAL_F] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_VictoryRoad_Rival_Flareon_Hard),
        .party = {.ItemCustomMoves = sParty_VictoryRoad_Rival_Flareon_Hard}
    },
    [TRAINER_VICTORY_ROAD_RIVAL_E] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_VictoryRoad_Rival_Espeon_Hard),
        .party = {.ItemCustomMoves = sParty_VictoryRoad_Rival_Espeon_Hard}
    },
    [TRAINER_VICTORY_ROAD_RIVAL_U] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_VictoryRoad_Rival_Umbreon_Hard),
        .party = {.ItemCustomMoves = sParty_VictoryRoad_Rival_Umbreon_Hard}
    },
    [TRAINER_VICTORY_ROAD_RIVAL_L] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_VictoryRoad_Rival_Leafeon_Hard),
        .party = {.ItemCustomMoves = sParty_VictoryRoad_Rival_Leafeon_Hard}
    },
    [TRAINER_VICTORY_ROAD_RIVAL_G] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_VictoryRoad_Rival_Glaceon_Hard),
        .party = {.ItemCustomMoves = sParty_VictoryRoad_Rival_Glaceon_Hard}
    },
    [TRAINER_VICTORY_ROAD_RIVAL_S] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_VictoryRoad_Rival_Sylveon_Hard),
        .party = {.ItemCustomMoves = sParty_VictoryRoad_Rival_Sylveon_Hard}
    },
    // #endregion
    ...
    [TRAINER_DAIMYN_CITY_RIVAL_EXHIBITION_BATTLE_2] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival_ExhibitionBattle_SecondaryTeam_Hard),
        .party = {.ItemCustomMoves = sParty_Rival_ExhibitionBattle_SecondaryTeam_Hard}
    },
    [TRAINER_ASCENSION_TOWER_E4_HANNAH] = {
        ...
        .partySize = NELEMS(sParty_AscensionTower_EliteFour_Hannah_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_EliteFour_Hannah_Hard}
    },
    [TRAINER_ASCENSION_TOWER_E4_LUCAS] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_EliteFour_Lucas_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_EliteFour_Lucas_Hard}
    },
    [TRAINER_ASCENSION_TOWER_E4_JENNA] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_EliteFour_Jenna_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_EliteFour_Jenna_Hard}
    },
    [TRAINER_ASCENSION_TOWER_E4_THOMAS] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_EliteFour_Thomas_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_EliteFour_Thomas_Hard}
    },
    [TRAINER_ASCENSION_TOWER_CHAMPION_SELENE] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_Champion_Selene_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_Champion_Selene_Hard}
    },
    [TRAINER_ANTHRA_TOWN_ALISTAIR] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_RISKY | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_PostCredits_Alistair_Hard),
        .party = {.ItemCustomMoves = sParty_PostCredits_Alistair_Hard}
    },
    // #endregion
    // #region Elite Four Rematches
    [TRAINER_ASCENSION_TOWER_E4_HANNAH_REMATCH] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_EliteFour_HannahRematch_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_EliteFour_HannahRematch_Hard}
    },
    [TRAINER_ASCENSION_TOWER_E4_LUCAS_REMATCH] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_EliteFour_LucasRematch_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_EliteFour_LucasRematch_Hard}
    },
    [TRAINER_ASCENSION_TOWER_E4_JENNA_REMATCH] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_EliteFour_JennaRematch_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_EliteFour_JennaRematch_Hard}
    },
    [TRAINER_ASCENSION_TOWER_E4_THOMAS_REMATCH] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_EliteFour_ThomasRematch_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_EliteFour_ThomasRematch_Hard}
    },
    // #endregion
    // #region Title Defense
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_RIVAL_V] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Rival_Vaporeon_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Rival_Vaporeon_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_RIVAL_J] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Rival_Jolteon_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Rival_Jolteon_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_RIVAL_F] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Rival_Flareon_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Rival_Flareon_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_RIVAL_E] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Rival_Espeon_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Rival_Espeon_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_RIVAL_U] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Rival_Umbreon_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Rival_Umbreon_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_RIVAL_L] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Rival_Leafeon_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Rival_Leafeon_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_RIVAL_G] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Rival_Glaceon_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Rival_Glaceon_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_RIVAL_S] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Rival_Sylveon_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Rival_Sylveon_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_JOEY] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_YoungsterJoey_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_YoungsterJoey_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_SELENE] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Selene_WithVictini_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Selene_WithVictini_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_SELENE_AFTER_VICTINI] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Selene_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Selene_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_ALISTAIR] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Alistair_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Alistair_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_HAWTHORNE] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Hawthorne_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Hawthorne_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_CLANCY] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Clancy_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Clancy_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_ENA] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Ena_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Ena_Hard}
    },
    ...
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_FOREIGNER] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Felix_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Felix_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_COLLIN] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Collin_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Collin_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_CRYSTAL] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Crystal_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Crystal_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_IRENE] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Irene_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Irene_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_RONALD] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Ronald_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Ronald_Hard}
    },
    [TRAINER_ASCENSION_TOWER_TITLE_DEFENSE_KURTIS] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = TrainerAIFlags_AscensionTower_Hard,
        .partySize = NELEMS(sParty_AscensionTower_TitleDefense_Kurtis_Hard),
        .party = {.ItemCustomMoves = sParty_AscensionTower_TitleDefense_Kurtis_Hard}
    },
    [TRAINER_POSTGAME_RIVAL_EXHIBITION_BATTLE_V] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival_PostgameExhibitionBattle_Vaporeon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival_PostgameExhibitionBattle_Vaporeon_Hard}
    },
    [TRAINER_POSTGAME_RIVAL_EXHIBITION_BATTLE_J] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival_PostgameExhibitionBattle_Jolteon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival_PostgameExhibitionBattle_Jolteon_Hard}
    },
    [TRAINER_POSTGAME_RIVAL_EXHIBITION_BATTLE_F] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival_PostgameExhibitionBattle_Flareon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival_PostgameExhibitionBattle_Flareon_Hard}
    },
    [TRAINER_POSTGAME_RIVAL_EXHIBITION_BATTLE_E] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival_PostgameExhibitionBattle_Espeon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival_PostgameExhibitionBattle_Espeon_Hard}
    },
    [TRAINER_POSTGAME_RIVAL_EXHIBITION_BATTLE_U] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival_PostgameExhibitionBattle_Umbreon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival_PostgameExhibitionBattle_Umbreon_Hard}
    },
    [TRAINER_POSTGAME_RIVAL_EXHIBITION_BATTLE_L] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival_PostgameExhibitionBattle_Leafeon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival_PostgameExhibitionBattle_Leafeon_Hard}
    },
    [TRAINER_POSTGAME_RIVAL_EXHIBITION_BATTLE_G] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival_PostgameExhibitionBattle_Glaceon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival_PostgameExhibitionBattle_Glaceon_Hard}
    },
    [TRAINER_POSTGAME_RIVAL_EXHIBITION_BATTLE_S] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SEMI_SMART,
        .partySize = NELEMS(sParty_Rival_PostgameExhibitionBattle_Sylveon_Hard),
        .party = {.ItemCustomMoves = sParty_Rival_PostgameExhibitionBattle_Sylveon_Hard}
    },
