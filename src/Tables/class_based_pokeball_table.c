...
const u8 gClassPokeBalls[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_SENSEI] =     	  BALL_TYPE_ULTRA_BALL,
	[CLASS_DISCIPLE] =        BALL_TYPE_POKE_BALL,
	[CLASS_PKMN_TRAINER_4] =   BALL_TYPE_ULTRA_BALL,
	[CLASS_RUIN_MANIAC_RS] =  BALL_TYPE_POKE_BALL,
	[CLASS_CHALLENGER] =     BALL_TYPE_ULTRA_BALL,
	...
	[CLASS_DEVELOPER] =		  BALL_TYPE_MASTER_BALL,
	[CLASS_GYM_TRAINEE] =     BALL_TYPE_GREAT_BALL,
	[CLASS_LASS_RS] =         BALL_TYPE_POKE_BALL,
	[CLASS_BUG_CATCHER_RS] =  BALL_TYPE_NET_BALL,
	[CLASS_HIKER_RS] =        BALL_TYPE_POKE_BALL,
	[CLASS_BATTLE_FRONTIER_BRAIN_RS] = BALL_TYPE_MASTER_BALL, // Unused; was Young Couple
	...
	[CLASS_CHAMPION] =        BALL_TYPE_MASTER_BALL,
	[CLASS_CHANNELER] =       BALL_TYPE_POKE_BALL,
	[CLASS_TWINS] =           BALL_TYPE_REPEAT_BALL,
	[CLASS_BATTLE_FRONTIER_ACE] =     BALL_TYPE_ULTRA_BALL,
	[CLASS_BATTLE_FRONTIER_BRAIN] =    BALL_TYPE_MASTER_BALL,
