...
static const struct SpriteFrameImage Table_Volcanion[] =
{
    overworld_frame(VolcanionTiles, 4, 4, 0),
    overworld_frame(VolcanionTiles, 4, 4, 1),
    overworld_frame(VolcanionTiles, 4, 4, 2),
    overworld_frame(VolcanionTiles, 4, 4, 3),
    overworld_frame(VolcanionTiles, 4, 4, 4),
    overworld_frame(VolcanionTiles, 4, 4, 5),
...
const struct EventObjectGraphicsInfo GraphicsInfo_Volcanion =
{
    .tileTag = 0xFFFF,
    .paletteTag1 = 0x123B,
    .paletteTag2 = EVENT_OBJ_PAL_TAG_NONE,
