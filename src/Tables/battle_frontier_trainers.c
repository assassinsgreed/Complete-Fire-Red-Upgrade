...
const struct SpecialBattleFrontierTrainer gSpecialTowerTrainers[] =
{
	// Used for streak 20 trainers
	{
		...
		.legendarySpreads = gLegendaryTowerSpread_Mort,
		...
		.legSpreadSize =	NELEMS(gLegendaryTowerSpread_Mort),
	...
	},
	{
		...
		.legendarySpreads = gLegendaryTowerSpread_Rival,
		...
		.legSpreadSize =	NELEMS(gLegendaryTowerSpread_Rival),
		.songId = 			BGM_BATTLE_FRONTIER_BOSS,
		.isMonotype = 		FALSE,
	},
	{
		...
		.legendarySpreads = gLegendaryTowerSpread_Selene,
		...
		.legSpreadSize =	NELEMS(gLegendaryTowerSpread_Selene),
		.songId = 			BGM_BATTLE_FRONTIER_BOSS,
		.isMonotype = 		FALSE,
	},
	{
		...
		.legendarySpreads = gLegendaryTowerSpread_Alistair,
		...
		.legSpreadSize =	NELEMS(gLegendaryTowerSpread_Alistair),
		.songId = 			BGM_BATTLE_FRONTIER_BOSS,
		.isMonotype = 		FALSE,
	},
	{
		...
		.legendarySpreads = gLegendaryTowerSpread_Mort, // Reused
	...
	},
	{
		...
		.legendarySpreads = gLegendaryTowerSpread_Rival, // Reused
	...
	},
	{
		...
		.legendarySpreads = gLegendaryTowerSpread_Brendan,
		...
		.legSpreadSize =	NELEMS(gLegendaryTowerSpread_Brendan),
		.songId = 			BGM_BATTLE_FRONTIER_BOSS,
		.isMonotype = 		FALSE,
	},
	{
	...
	[0] =
		{
			...
			.legendarySpreads = gLegendaryTowerSpread_Terrence,
			...
			.legSpreadSize =	NELEMS(gLegendaryTowerSpread_Terrence),
	...
	[1] =
		{
			...
			.legendarySpreads = gLegendaryTowerSpread_Stella,
			...
			.legSpreadSize =	NELEMS(gLegendaryTowerSpread_Stella),
	...
	[2] =
		{
			...
			.legendarySpreads = gLegendaryTowerSpread_Raine,
			...
			.legSpreadSize =	NELEMS(gLegendaryTowerSpread_Raine),
	...
	[3] =
		{
			...
			.legendarySpreads = gLegendaryTowerSpread_Chance,
			...
			.legSpreadSize =	NELEMS(gLegendaryTowerSpread_Chance),
	...
	[4] = //Swapped to the female graphics at runtime if the player is male - see UseFemaleCaseyFrontierBrain
		{
			...
			.legendarySpreads = gLegendaryTowerSpread_Casey,
			...
			.legSpreadSize =	NELEMS(gLegendaryTowerSpread_Casey),
	...
	[5] =
		{
			...
			.legendarySpreads = gLegendaryTowerSpread_Abby,
			...
			.legSpreadSize =	NELEMS(gLegendaryTowerSpread_Abby),
	...
	[6] =
		{
			...
			.legendarySpreads = gLegendaryTowerSpread_Iris,
			...
			.legSpreadSize =	NELEMS(gLegendaryTowerSpread_Iris),
	...
	[7] =
		{
			...
			.legendarySpreads = gLegendaryTowerSpread_Dennis,
			...
			.legSpreadSize =	NELEMS(gLegendaryTowerSpread_Dennis),
