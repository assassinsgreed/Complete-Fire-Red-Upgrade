...
const u16 gClassBasedTrainerEncounterBGM[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_TEAM_PLUTO] = BGM_TEAM_PLUTO_PRE_BATTLE,
	[CLASS_TEAM_PLUTO_ADMIN] = BGM_TEAM_PLUTO_PRE_BATTLE,
	[CLASS_TEAM_PLUTO_LEADER] = BGM_TEAM_PLUTO_PRE_BATTLE,
	[CLASS_COOLTRAINER] = BGM_EYE_ACE_TRAINER,
	[CLASS_ELITE_4] = BGM_EYE_ACE_TRAINER,
	[CLASS_GENTLEMAN] = BGM_EYE_GENTLEMAN,
	[CLASS_RIVAL_2] = BGM_EYE_BOY,
	[CLASS_CHAMPION] = BGM_EYE_BOY,
	[CLASS_CHANNELER] = BGM_EYE_CREEPY,
	[CLASS_TWINS] =  BGM_EYE_TWINS,
	[CLASS_BATTLE_FRONTIER_ACE] = BGM_EYE_BATTLE_FRONTIER_BOSS,
	[CLASS_BATTLE_FRONTIER_BRAIN] = BGM_EYE_BATTLE_FRONTIER_BOSS,
	[CLASS_CRUSH_KIN] = BGM_EYE_BOY,
	[CLASS_SIS_AND_BRO] =  BGM_EYE_TWINS,
	[CLASS_PKMN_PROF] = BGM_EYE_ACE_TRAINER,
	...
	[CLASS_RUIN_MANIAC] = BGM_EYE_GENTLEMAN,
	[CLASS_LADY] =  BGM_EYE_PARASOL_LADY,
...
const u16 gClassBasedBattleBGM[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_ELITE_4] = BGM_BATTLE_ELITE_FOUR,
	[CLASS_RIVAL] = BGM_BATTLE_RIVAL, // More lighthearted
	[CLASS_RIVAL_2] = BGM_BATTLE_RIVAL_2, // More serious
	[CLASS_TEAM_PLUTO] = BGM_BATTLE_TEAM_PLUTO_GRUNTS,
	[CLASS_TEAM_PLUTO_ADMIN] = BGM_BATTLE_TEAM_PLUTO_ADMINS,
	[CLASS_TEAM_PLUTO_LEADER] = BGM_BATTLE_TEAM_PLUTO_KURTIS,
	[CLASS_PKMN_TRAINER_1] = BGM_BATTLE_CASEY,
	[CLASS_PKMN_TRAINER_3] = BGM_BATTLE_TRAINER_HOUSE, // Trainer House
	[CLASS_PKMN_TRAINER_4] = BGM_BATTLE_ALISTAIR,
	[CLASS_SENSEI] = BGM_BATTLE_KAITO_THEME,
	[CLASS_DEVELOPER] = BGM_BATTLE_TRAINER_HOUSE
};
...
const u16 gWildSpeciesBasedBattleBGM[] =
{
	...
	[SPECIES_LATIOS] = BGM_BATTLE_ELITE_FOUR,
	[SPECIES_LATIAS] = BGM_BATTLE_ELITE_FOUR,
	[SPECIES_GROUDON_PRIMAL] = BGM_BATTLE_DEOXYS,
	[SPECIES_KYOGRE_PRIMAL] = BGM_BATTLE_DEOXYS,
	[SPECIES_RAYQUAZA] = BGM_BATTLE_ELITE_FOUR,
	[SPECIES_JIRACHI] = BGM_BATTLE_MEWTWO,
	[SPECIES_DEOXYS] = BGM_BATTLE_DEOXYS,
	[SPECIES_GLASTRIER] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_SHAYMIN] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_ZERAORA] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_MELTAN] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_VOLCANION] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_COSMOG] = BGM_BATTLE_REGI_TRIO,
	[SPECIES_NIHILEGO] = BGM_BATTLE_REGI_TRIO,
	[SPECIES_BUZZWOLE] = BGM_BATTLE_REGI_TRIO,
	[SPECIES_PHEROMOSA] = BGM_BATTLE_REGI_TRIO,
	[SPECIES_XURKITREE] = BGM_BATTLE_REGI_TRIO,
	[SPECIES_CELESTEELA] = BGM_BATTLE_REGI_TRIO,
	[SPECIES_KARTANA] = BGM_BATTLE_REGI_TRIO,
	[SPECIES_GUZZLORD] = BGM_BATTLE_REGI_TRIO,
	[SPECIES_STAKATAKA] = BGM_BATTLE_REGI_TRIO,
	[SPECIES_BLACEPHALON] = BGM_BATTLE_REGI_TRIO,
	...
	[SPECIES_XERNEAS] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_LUGIA] = BGM_BATTLE_DEOXYS,
	[SPECIES_HOOPA] = BGM_BATTLE_DEOXYS,
	[SPECIES_HEATRAN] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_ZARUDE] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_SPECTRIER] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_GENESECT] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_DARKRAI] = BGM_BATTLE_LEGENDARY_BIRDS,
};

// This is only used by the battle frontier
const u16 gRandomBattleMusicOptions[] =
{
	...
	BGM_BATTLE_CHAMPION,
	BGM_BATTLE_WILD, // Wild pokemon
	BGM_BATTLE_LEGENDARY_BIRDS, // Minor legendaries
	BGM_BATTLE_MEWTWO, // Jirachi
