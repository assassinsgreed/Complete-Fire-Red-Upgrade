...
extern const u8 gText_BadTantrum[];
...
static const u8* sTutorsBruccie[] =
{
	gText_BugBite,
	gText_IronDefense,
	gText_LastResort,
...
static const u8* sTutorsTsarvosa[] =
{
	gText_Synthesis,
	gText_SignalBeam,
	gText_IronHead,
...
void CheckIfCaught()
{
	u16 speciesNum = VarGet(gSpecialVar_LastResult);
	gSpecialVar_LastResult = GetSetPokedexFlag(SpeciesToNationalPokedexNum(speciesNum), FLAG_GET_CAUGHT);
}
