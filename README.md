...
This is my personal fork of CFRU for the Pokemon Amethyst romhack. External dev resources are required to build and develop the game, but you can play the fully compiled version found on [HackDex](https://www.hackdex.app/hack/pokemon-amethyst)!
