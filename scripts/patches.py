...
def main():
    ...
    with open(ROM_NAME, 'rb+') as romfile:
        ...
        # The Continue Screen Party patch reads MON_DATA_SPECIES (11) when picking each party icon, which
        # returns an egg's hidden inner species; use MON_DATA_SPECIES2 (65) instead.
        for iconLoopSpeciesRead in (0x76A544, 0x76A5BE):
            romfile.seek(iconLoopSpeciesRead)
            romfile.write(b'\x41\x21') # movs r1, #65
